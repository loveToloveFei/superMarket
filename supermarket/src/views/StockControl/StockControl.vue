		...
		<el-row>
			...
			>
				<el-form :model="resetUserForm" :rules="rules" ref="resetUserForm">
					...
					<el-form-item label="库存" label-width="80px" center prop="commodityInStock">
						<el-input v-model="resetUserForm.commodityInStock" autocomplete="off"></el-input>
					</el-form-item>
				</el-form>
